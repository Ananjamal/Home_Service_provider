        ...
        <div class="card-body">
            ...
            <h5 class="card-title">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    class="bi bi-house-gear-fill" viewBox="0 0 20 20">
                    <path
                    ...
                    <tbody>
                        @foreach ($services as $item)
                            <tr>
                                ...
                                <td class="text-center align-middle">{{ $item->service_name }}</td>
                                <td class="text-center align-middle">{{ $item->description }}</td>
                                <td class="text-center align-middle">
                                    <img src="{{ asset('storage/' . $item->image) }}" height="70" width="70" alt="image not found">
                                </td>
